...
// Import your custom action providers here
// Example: import { exampleCustomActionProvider } from "./action-providers/example-custom-provider";
import { litActionProvider } from "./action-providers/lit-action-provider";
  ...
  try {
    ...
    const agentkit = await AgentKit.from({
      ...
      actionProviders: [
        ...
        // exampleCustomActionProvider(),
        // Lit Protocol action provider
        litActionProvider({
          litNetwork: (process.env.LIT_NETWORK as any) || "datil-dev",
